...
{ 
	...
	{ 
		...
		r.connect(); 
		r.runMotor(RXTXRobot.MOTOR4, 125, 500); // Run motor 1 forward (speed of 125) for 5 seconds 
		// Program stops until the command above is completed (5 seconds) 
		r.runMotor(RXTXRobot.MOTOR4, -125, 300); // Run motor 1 backward (speed of 125) for 3 seconds 
		r.close(); 
	} 
}